...
if (isset($_POST['grades']) && is_array($_POST['grades'])) {
  ...
  header("Location: ".$_SERVER['PHP_SELF']."?$qs&page=7");
    exit;
}
...
<form method="get" class="filter">
  ...
  <?php if (isset($_GET['saved'])): ?><span style="color:green">✔ посещаемости сохранены</span><?php endif; ?>
</form>
    ...
    <table>
      <thead>
        <tr>
          ...
          <th class="col-avg" rowspan="2">Средняя посещаемость
          </th>
...
foreach ($students as $st): 
    ...
    $attendancePercent = $totalDays > 0 ? round(100 - ($absences / $totalDays * 100), 1) : 0;
?>
<tr>
  ...
  ?>
    <td>
      <input class="grade-input" type="text"
             value="<?= $isAbsent ? 'н/б' : '' ?>" readonly>
    </td>
  <?php endforeach; ?>
  <td class="col-avg"><?= $attendancePercent ?>%</td>
  <td class="col-final"><?= $absences ?></td>
</tr>
<?php endforeach; ?>
</tbody>
  ...
  <p align="center"><button type="submit" class="btn btn-success">Сохранить посещаемость</button></p>
</form>
